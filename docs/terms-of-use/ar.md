تقدم Walletika Platform، Inc. و / أو الشركات التابعة لها ("نحن" أو "خاصتنا" أو "نحن") خدماتها البرمجية من خلال موقعها على الويب الموجود على [walletika.github.io](https://walletika.github.io) وتطبيقات الهاتف المحمول والمنتجات ذات الصلة (يشار إليها إجمالاً بـ "الخدمات" أو "Walletika").
...
## سياسة الخصوصية
- للحصول على شرح لكيفية جمع المعلومات من مستخدمينا واستخدامها والكشف عنها، يرجى الاطلاع على سياسة الخصوصية : https://walletika.github.io/#/documents/user-agreement/privacy-policy.
